export interface IFinanceAppConfig {
    version: number;
    formatAsCurrency: boolean;
    fyOffset: number;
    tableConfig: {
        //leave column array empty if you do not want to use this
        summaryColumns: Array<object>;
        ...
        rows: Array<{key:string;label:string;headerRow:boolean;}>;
        cellClass: string;
    ...
    mltGuids: Array<string>;
    yAxisLabel: string;
    selectedYearFieldId: string;
    calculations: Array<{fieldId?:string;function:string;key:string;label:string;labelWidth?:string;}>;
    EcfWebpartId: string;
    debugMode: boolean;
